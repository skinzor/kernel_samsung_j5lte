...
// NOTE: profile values in this version are specificly for Galaxy J5 version!
static char profiles_file_version[20] = "0.3 beta8 Galaxy J5";
...
struct zzmoove_profile zzmoove_profiles[] = {
	{
		1,		// Default Profile
		"def",		// default settings as hardcoded in the governor (please don't remove this profile)  - modified to use GALAXY J5 freq
#ifdef ENABLE_AUTO_ADJUST_FREQ
		...
		533333,		// music_min_freq (0=disable, range from 0 to freq->min in khz)
 ...
 */
		2,
		"ybat",		// Yank555.lu Battery Profile (please don't remove this profile) - modified to use GALAXY J5 freq
#ifdef ENABLE_AUTO_ADJUST_FREQ
		0,		// auto_adjust_freq_thresholds (any value=enable, 0=disable)
#endif /* ENABLE_AUTO_ADJUST_FREQ */
#ifdef ENABLE_HOTPLUGGING
...
#if (MAX_CORES == 6 || MAX_CORES == 8)
		55,		// down_threshold_hotplug4 (range from 1 to 100 and should be lower than up_threshold_hotplug4)
		55,		// down_threshold_hotplug5 (range from 1 to 100 and should be lower than up_threshold_hotplug7)
#endif /* (MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 8)
		55,		// down_threshold_hotplug6
		55,		// down_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		400000,		// down_threshold_hotplug_freq1 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq1)
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		400000,	// down_threshold_hotplug_freq2 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq2)
		400000,	// down_threshold_hotplug_freq3 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq3)
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 6 || MAX_CORES == 8)
		400000,		// down_threshold_hotplug_freq4 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq4)
		0,		// down_threshold_hotplug_freq5 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq5)
#endif /* (MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 8)
		0,		// down_threshold_hotplug_freq6 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq6)
		...
		0,		// freq_limit (0=disable, range in system table from freq->min to freq->max in khz)
#if defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) || defined(USE_LCD_NOTIFIER)
		533333,		// freq_limit_sleep (0=disable, range in system table from freq->min to freq->max in khz)
#endif /* defined(CONFIG_HAS_EARLYSUSPEND)... */
		...
		0,		// scaling_block_cycles (0=disable, any value above 0)
#ifdef CONFIG_EXYNOS4_EXPORT_TEMP
		0,		// scaling_block_temp (0=disable, range from 40°C to 69°C)
#endif /* CONFIG_EXYNOS4_EXPORT_TEMP */
#ifdef ENABLE_SNAP_THERMAL_SUPPORT
		0,		// scaling_trip_temp
#endif /* ENABLE_SNAP_THERMAL_SUPPORT */
...
#endif /* ENABLE_INPUTBOOSTER */
#ifdef ENABLE_MUSIC_LIMITS
		533333,	// music_max_freq (0=disable, range from 0 to freq->max in khz)
		533333,		// music_min_freq (0=disable, range from 0 to freq->min in khz)
		2,		// music_min_cores (0=disable, range from 1 to MAX_CORES)
#endif /* ENABLE_MUSIC_LIMITS */
		75,		// smooth_up (range from 1 to 100)
 ...
 */
		3,
		"ybatext",	// Yank555.lu Battery Extreme Profile (please don't remove this profile) - modified to use GALAXY J5
#ifdef ENABLE_AUTO_ADJUST_FREQ
		0,		// auto_adjust_freq_thresholds (any value=enable, 0=disable)
#endif /* ENABLE_AUTO_ADJUST_FREQ */
#ifdef ENABLE_HOTPLUGGING
...
#endif /* ENABLE_INPUTBOOSTER */
#ifdef ENABLE_MUSIC_LIMITS
		800000,	// music_max_freq (0=disable, range from 0 to freq->max in khz)
		533333,		// music_min_freq (0=disable, range from 0 to freq->min in khz)
		2,		// music_min_cores (0=disable, range from 1 to MAX_CORES)
#endif /* ENABLE_MUSIC_LIMITS */
		...
		533333,		// up_threshold_hotplug_freq3 (0 to disable core, range from 1 to scaling max and should be higher than down_threshold_hotplug_freq3)
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 6 || MAX_CORES == 8)
		533333,		// up_threshold_hotplug_freq4 (0 to disable core, range from 1 to scaling max and should be higher than down_threshold_hotplug_freq4)
		0,		// up_threshold_hotplug_freq5 (0 to disable core, range from 1 to scaling max and should be higher than down_threshold_hotplug_freq5)
#endif /* (MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 8)
		0,		// up_threshold_hotplug_freq6 (0 to disable core, range from 1 to scaling max and should be higher than down_threshold_hotplug_freq6)
 ...
 */
		4,
		"zzperf",	// ZaneZam Performance Profile (please don't remove this profile) - modified to use GALAXY J5 freq
#ifdef ENABLE_AUTO_ADJUST_FREQ
		0,		// auto_adjust_freq_thresholds (any value=enable, 0=disable)
#endif /* ENABLE_AUTO_ADJUST_FREQ */
#ifdef ENABLE_HOTPLUGGING
		...
		55,		// down_threshold_hotplug7 (range from 1 to 100 and should be lower than up_threshold_hotplug7)
#endif /* (MAX_CORES == 8) */
		800000,		// down_threshold_hotplug_freq1 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq1)
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		800000,		// down_threshold_hotplug_freq2 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq2)
		800000,	// down_threshold_hotplug_freq3 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq3)
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 6 || MAX_CORES == 8)
		800000,		// down_threshold_hotplug_freq4 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq4)
		0,		// down_threshold_hotplug_freq5 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq5)
#endif /* (MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 8)
		0,		// down_threshold_hotplug_freq6 (range from 0 to scaling max and should be lower than up_threshold_hotplug_freq6)
...
#endif /* ENABLE_HOTPLUGGING */
#if defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) || defined(USE_LCD_NOTIFIER)
		60,		// down_threshold_sleep (range from 11 to 100 and must be lower than up_threshold_sleep)
#endif /* defined(CONFIG_HAS_EARLYSUSPEND)... */
		0,		// early_demand (any value=enable, 0=disable)
#if defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) || defined(USE_LCD_NOTIFIER)
		1,		// early_demand_sleep (any value=enable, 0=disable)
...
#ifdef ENABLE_MUSIC_LIMITS
		998400,	// music_max_freq (0=disable, range from 0 to freq->max in khz)
		800000,		// music_min_freq (0=disable, range from 0 to freq->min in khz)
		2,		// music_min_cores (0=disable, range from 1 to MAX_CORES)
#endif /* ENABLE_MUSIC_LIMITS */
 ...
 */
		5,
		"zzrelax",	// ZaneZam Relax Profile (please don't remove this profile) - modified to use Galaxy J5 freq
#ifdef ENABLE_AUTO_ADJUST_FREQ
		0,		// auto_adjust_freq_thresholds (any value=enable, 0=disable)
#endif /* ENABLE_AUTO_ADJUST_FREQ */
#ifdef ENABLE_HOTPLUGGING
		...
		0,		// scaling_block_threshold (0=disable, range from 1 to 100)
		2,		// scaling_block_force_down (0=disable, range from 2 to any value)
		800000,		// scaling_fastdown_freq (0=disable, range in system table from freq->min to freq->max in khz)
		95,		// scaling_fastdown_up_threshold (range from over scaling_fastdown_down_threshold to 100)
		90,		// scaling_fastdown_down_threshold (range from 11 to under scaling_fastdown_up_threshold)
